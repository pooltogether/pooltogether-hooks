...
import { APP_ENVIRONMENTS } from './hooks/useIsTestnets'
...
// V3 contract addresses to maintain support for.
export const V3 = Object.freeze({
  ...
  POOL_PRIZE_POOL_ADDRESSES: {
    [NETWORK.mainnet]: ['0x396b4489da692788e327e2e4b2b0459a5ef26791'],
    [NETWORK.polygon]: ['0x2aC049f07d56Ed04F84Ff80022A71a1A2d8cE19b'], // Don't show staking for Polygon pool
    [NETWORK.rinkeby]: ['0x4706856fa8bb747d50b4ef8547fe51ab5edc4ac2']
  }
})
